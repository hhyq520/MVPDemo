...
import com.ztd.mvpstandardpro_as.url.UrlHelper;
import com.ztd.mvpstandardpro_as.utils.NetworkUtil;
    ...
    private static Interceptor addCacheInterceptor() {
        Interceptor cacheInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!NetworkUtil.isNetworkAvailable(ProApplication.getAppContext())) {
